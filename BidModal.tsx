                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[rgba(255,255,255,0.40)] mt-1 leading-relaxed">
                      SOL goes to escrow on {import.meta.env.VITE_NETWORK === 'mainnet-beta' ? 'Mainnet' : 'Devnet'}. {auction.currency === 'USDC' ? 'Bid routed via MagicBlock Private Rollup (TEE) â€” amount hidden on-chain until auction ends.' : 'Nobody can see your bid amount until auction ends.'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="p-3 bg-yellow-500/5 border border-yellow-500/20 rounded-xl flex items-start gap-2.5">
                ...
                <p className="text-xs text-yellow-400/80">
                  Your {provider} wallet will ask you to approve this transaction. Bids are final â€” no cancellation after signing.
                </p>
              </div>
