...
export default function ExplorePage({ isDemoMode = false }: ExploreProps) {
  ...
  const heroTop = 'pt-[185px] sm:pt-[88px]'
    ...
    <>
      ...
      <section className={`${heroTop} pb-12 px-4 sm:px-6 max-w-7xl mx-auto`}>
        ...
        <div className="text-center space-y-5">
          ...
          {/* Headline */}
          <h1 className="text-[32px] sm:text-[60px] lg:text-[72px] font-[Syne,sans-serif] leading-[0.95] text-white" style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, letterSpacing: '-0.04em' }}>
            Private Sealed-Bid
            <br />
      ...
      {/* Fixed filters */}
      <div className="fixed left-0 right-0 z-40 top-[98px] sm:top-[60px]" style={{ background: 'rgba(8,8,8,0.92)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
      ...
      {/* Grid */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 pt-[60px]">
        {loading ? (
